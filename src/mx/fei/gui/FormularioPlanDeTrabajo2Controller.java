 ...
 * @author adolf
 */
public class FormularioPlanDeTrabajo2Controller implements Initializable {
    ...
    public void cargarSiguientePagina(){
        ...
        Stage actualStage = (Stage) botonSiguiente.getScene().getWindow();
        try {
            Parent root = FXMLLoader.load(getClass().getResource("FormularioPlanDeTrabajo3.fxml"));
